...
**Bouncy jump physics when moving items in your inventory.**
...
- **Smooth rotation** — items tilt left and right during the jump.
- **Fully configurable** — tweak everything in the config menu.
...
| Setting | Description |
| :--- | :--- |
| **Duration** | How long the jump animation lasts. |
| **Bounces** | Number of bounces before landing. |
| **Height** | Maximum jump height. |
| **Angle** | Maximum rotation angle during the jump. |
| **Size** | Scale of the item during the animation. |

All settings are live — no need to restart the game.
...
Available on:
- [Modrinth](https://modrinth.com/mod/physics-swapping)
- [GitHub Releases](https://github.com/ender-fake/physicsswapping/releases)
